...
1. Blue Team Introduction: Start your defensive security career by exploring the Blue Team and its core - the Security Operations Centre (SOC). You’ll learn why defensive security is essential and how it helps organisations stay protected against attacks.<br><br>
   &nbsp;&nbsp;1.1.   &nbsp; 🔗  &nbsp; Junior Security Analyst Intr<br>
   &nbsp;&nbsp;1.2.   &nbsp; 🔗  &nbsp; [SOC Role in Blue Team](https://github.com/RosanaFSS/Cybersecurity-Journey-TryHackMe/blob/CTFs-&-Infos/Easy%20%F0%9F%94%97%20-%20SOC%20Role%20in%20Blue%20Team.md)<br>
   &nbsp;&nbsp;1.3.   &nbsp; 🔗  &nbsp; [Humans as Attack Vectors](https://github.com/RosanaFSS/Cybersecurity-Journey-TryHackMe/blob/CTFs-&-Infos/Easy%20%F0%9F%94%97%20-%20Humans%20as%20Attack%20Vectors.md)<br>
   &nbsp;&nbsp;1.4.   &nbsp; 🔗  &nbsp; [Systems as Attack Vectors](https://github.com/RosanaFSS/Cybersecurity-Journey-TryHackMe/blob/CTFs-&-Infos/Easy%20%F0%9F%94%97%20-%20Systems%20as%20Attack%20Vectors.md)<br><br><br>
2. SOC Team Internals<br>Explore the essential SOC analyst skills to help you triage, classify, and escalate alerts in real-world SOC environments.<br><br>
   2.1.   &nbsp; 🔗  &nbsp; [SOC L1 Alert Triage](https://github.com/RosanaFSS/Cybersecurity-Journey-TryHackMe/blob/CTFs-&-Infos/Easy%20%F0%9F%94%97%20-%20SOC%20L1%20Alert%20Triage.md)<br>
   ...
   2.5.   &nbsp; ⚙️  &nbsp; <strong>Introduction to Phishing</strong><br><br><br>
3. Core SOC Solutions<br>Understanding security solutions is key for SOC analysts.<br>This module covers SIEM, EDR and SOAR, the core security solutions used in a SOC.<br><br>
   3.1.   &nbsp; 🔗  &nbsp; [Introduction to EDR](https://github.com/RosanaFSS/Cybersecurity-Journey-TryHackMe/blob/CTFs-&-Infos/Easy%20%F0%9F%94%97%20-%20Introduction%20to%20EDR.md)<br>
   3.2.   &nbsp; 🔗  &nbsp; Introduction to SIEM<br>
   3.3.   &nbsp; 🔗  &nbsp; Splunk: The Basics<br>
   3.4.   &nbsp; 🔗  &nbsp; Elastic Stack: The Basics<br>
   3.5.   &nbsp; 🔗  &nbsp; Introduction to SOAR<br><br><br>
4. Cyber Defence Frameworks<br>Learn how defensive frameworks, such as Pyramid of Pain, Cyber Kill Chain, and MITRE, help you understand adversarial behaviour and harden detection, triage, and response.<br><br>
   4.1.   &nbsp; 🔗  &nbsp; Pyramid of Pain<br>
   4.2.   &nbsp; 🔗  &nbsp; [Cyber Kill Chain](https://github.com/RosanaFSS/Cybersecurity-Journey-TryHackMe/blob/CTFs-&-Infos/Medium%20%F0%9F%94%97%20-%20Cyber%20Kill%20Chain.md)<br>
   ...
   4.5.   &nbsp; 🚩  &nbsp; Summit<br>
   4.6.   &nbsp; 🚩  &nbsp; Eviction<br><br><br>
5. Phishing Analysis<br>Learn how to analyse and defend against phishing emails. Investigate real-world phishing attempts using a variety of techniques.<br><br>
   5.1.   &nbsp; 🔗  &nbsp; Phishing Analysis Fundamentals<br>
   5.2.   &nbsp; 🔗  &nbsp; Phishing Emails in Action<br>
   5.3.   &nbsp; 🔗  &nbsp; Phishing Analysis Tools<br>
   5.4.   &nbsp; 🔗  &nbsp; Phishing Prevention<br>
   5.5.   &nbsp; 🚩  &nbsp; The Greenholt Phish<br>
   5.6.   &nbsp; 🚩  &nbsp; Snapped Phish-ing Line<br>
   5.7.   &nbsp; ⚙️  &nbsp; Phishing Unfolding<br><br><br>
...
11. Malware Concepts for SOC<br>In this module, you’ll learn to identify common malware types, understand their purpose, analyse files and understand why living off the land attacks are becoming more common.<br><br>
   11.1.   &nbsp; 🔗  &nbsp; Malware Classification<br>
   11.2.   &nbsp; 🔗  &nbsp; Intro to Malware Analysis<br>
   11.3.   &nbsp; 🔗  &nbsp; Living Off the Land Attacks<br>
   11.4.   &nbsp; 🚩  &nbsp; Shadow Trace<br><br><br>
12. Threat Analysis Tools<br>Understand how to leverage threat intelligence to detect, investigate and defend against adversaries.<br>Gain practical skills in using threat data, enrichment techniques, and analysis workflows to strengthen SOC capabilities.<br>
   ...
   12.4.   &nbsp; 🚩  &nbsp; [Invite Only](https://github.com/RosanaFSS/Cybersecurity-Journey-TryHackMe/blob/CTFs-%26-Infos/Easy%20%F0%9F%9A%A9%20-%20Invite%20Only.md)<br><br><br>
13. SIEM Triage for SOC<br>Explore how SIEM solutions help detect early signs of attacks, investigate SOC alerts, and correlate logs from multiple sources to build an incident timeline. These skills will be vital for you to identify and respond to real-world threats as a SOC analyst.<br><br>
...
14. SOC Level 1 Capstone Challenges<br>nvestigate critical incidents and apply all the skills needed to be an effective SOC analyst while handling various artefacts.<br>
   ...
   14.6.   &nbsp; ⚙️  &nbsp; Open Door<br><br><br>
15. Security Analyst Level1 (SAL 1):Get hired with an industry-recgsed, practical defensive certification.<br><br></p>


<h1>SOC Team Internal</h1>
<p>2026, January 1</p>
<h1>Introduction to Phishing</h1>
<p>10 min . +360 xps . Easy</p>
...
- Monitor and analyze real-time alerts.<br>
Identify and document critical events such as suspicious emails and attachments.<br>
...
<h3>Choose your SIEM tool</h3>
<p>Choose the platform you'd like to use during this simulation. Select Splunk, Elastic or Sentinel depending on what you're familiar with or want to explore</p>

<p>

- Splunk: Best for users familiar with or training in this industry-standard tool.<br>
- Elastic: Great for those with experience using Kibana and Elasticsearch.<br>
- Sentinel: For users comfortable with Microsoft, KQL, Log Analytics Workspace, and Sentinel.</p>

<p><em>[Start scenarion]</em></p>

<p>

<strong>Step 1 - Find all the true positives</>strong>: To complete a Scenario, find all the True Positive alerts. Keep triaging alerts until you've closed them all!<br>
<strong>Step 2 - Read the documentation</strong>: 
