...
<em>This is a machine that allows you to practise web app hacking and privilege escalation using recent vulnerabilities.</em> Click <a href="https://tryhackme.com/room/cmspit">here </a>to access the "room".<br>
