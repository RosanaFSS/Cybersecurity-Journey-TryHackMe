...
| `30679`<br><br>    |`HTTP`<br><br>        |PHP CLI server<br><br>           |-<br><br><br>                   |HTTP banner confirms PHP CLI Server 5.5+ with version `PHP 8.1.0-dev`. Page title indicates custom `dev/test` page.                                        |
