...
!function (a, b) {
  ...
  n.fn = n.prototype = {jquery: m, constructor: n, selector: "", length: 0, toArray: function () {
    ...
    for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == typeof g || n.isFunction(g) || (g = {}), h === i && (g = this, h--); i > h; h++) if (null != (a = arguments[h])) for (b in a) c = g[b], d = a[b], g !== d && (j && d && (n.isPlainObject(d) || (e = n.isArray(d))) ? (e ? (e = false, f = c && n.isArray(c) ? c : []) : f = c && n.isPlainObject(c) ? c : {}, g[b] = n.extend(j, f, d)) : undefined !== d && (g[b] = d));
    return g;
    ...
    }, f.guid = a.guid = a.guid || n.guid++, f) : undefined;
  ...
  var t = function (a) {
    var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + 1 * new Date, v = a.document, w = 0, x = 0, y = hb(), z = hb(), A = hb(), C = -2147483648, D = {}.hasOwnProperty, E = [], F = E.pop, G = E.push, H = E.push, I = E.slice, J = function (a, b) {
      ...
      if (!e && p) {
        ...
        if (c.qsa && (!q || !q.test(a))) {
          if (s = r = u, w = b, x = 1 !== k && a, 1 === k && "object" !== b.nodeName.toLowerCase()) {
            ...
            w = ab.test(a) && (b.parentNode && "undefined" != typeof b.parentNode.getElementsByTagName && b.parentNode) || b, x = o.join(",");
          }
          if (x) try {
    ...
    c = gb.support = {}, f = gb.isXML = function (a) {
      ...
      return g !== n && 9 === g.nodeType && g.documentElement ? (n = g, o = g.documentElement, e = g.defaultView, e && e !== e.top && (e.addEventListener ? e.addEventListener("unload", eb, false) : e.attachEvent && e.attachEvent("onunload", eb)), p = !f(g), c.attributes = jb(function (a) {
        ...
        return p ? b.getElementsByClassName(a) : undefined;
      ...
      return c;
    }, d = gb.selectors = {cacheLength: 50, createPseudo: ib, match: X, attrHandle: {}, find: {}, relative: {">": {dir: "parentNode", first: true}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: true}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (a) {
    ...
    for (b in {radio: true, checkbox: true, file: true, password: true, image: true}) d.pseudos[b] = mb(b);
    for (b in {submit: true, reset: true}) d.pseudos[b] = nb(b);
    function qb() {}
    ...
    function wb(a, b, c, d, e, f) {
      return d && !d[u] && (d = wb(d)), e && !e[u] && (e = wb(e, f)), (function (f, g, h, i) {
    ...
    return h = gb.compile = function (a, b) {
      ...
      if (e = e || [], 1 === o.length) {
        ...
        while (i--) {
          ...
          if ((m = d.find[l]) && (f = m(k.matches[0].replace(cb, db), ab.test(j[0].type) && (b.parentNode && "undefined" != typeof b.parentNode.getElementsByTagName && b.parentNode) || b))) {
            if (j.splice(i, 1), a = f.length && rb(j), !a) return H.apply(e, f), e;
            break;
          }
        }
      }
      return (n || h(a, o))(f, b, !p, e, ab.test(a) && (b.parentNode && "undefined" != typeof b.parentNode.getElementsByTagName && b.parentNode) || b), e;
    }, c.sortStable = u.split("").sort(B).join("") === u, c.detectDuplicates = !!l, m(), c.sortDetached = jb(function (a) {
      return 1 & a.compareDocumentPosition(n.createElement("div"));
    }), jb(function (a) {
      return a.innerHTML = "<a href='#'></a>", "#" === a.firstChild.getAttribute("href");
    }) || ("type|href|height|width".type = (null !== "type|href|height|width".getAttribute("type")) + "/" + "type|href|height|width".type, "type|href|height|width"), c.attributes && jb(function (a) {
      return a.innerHTML = "<input/>", a.firstChild.setAttribute("value", ""), "" === a.firstChild.getAttribute("value");
    }) || ("value".type = (null !== "value".getAttribute("type")) + "/" + "value".type, "value"), jb(function (a) {
      return null == a.getAttribute("disabled");
    }) || (K.type = (null !== K.getAttribute("type")) + "/" + K.type, K), gb;
  }(a);
  ...
  var y, z = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, A = n.fn.init = function (a, b) {
    ...
    if ("string" == typeof a) {
      ...
      if (c[1]) {
        if (b = b instanceof n ? b[0] : b, n.merge(this, n.parseHTML(c[1], b && b.nodeType ? b.ownerDocument || b : l, true)), v.test(c[1]) && n.isPlainObject(b)) for (c in b) n.isFunction(this[c]) ? this[c](b[c]) : this.attr(c, b[c]);
        return this;
      }
      return d = l.getElementById(c[2]), d && d.parentNode && (this.length = 1, this[0] = d), this.context = l, this.selector = a, this;
    }
    return a.nodeType ? (this.context = this[0] = a, this.length = 1, this) : n.isFunction(a) ? "undefined" != typeof y.ready ? y.ready(a) : a(n) : (undefined !== a.selector && (this.selector = a.selector, this.context = a.context), n.makeArray(a, this));
  };
  ...
  n.Callbacks = function (a) {
    ...
    var b, c, d, e, f, g, h = [], i = !a.once && [], j = function (l) {
      for (b = a.memory && l, c = true, g = e || 0, e = 0, f = h.length, d = true; h && f > g; g++) if (h[g].apply(l[0], l[1]) === false && a.stopOnFalse) {
        b = false;
        break;
      }
  ...
  var J = n.access = function (a, b, c, d, e, f, g) {
    ...
    if ("object" === n.type(c)) {
      e = true;
      for (h in c) n.access(a, b, h, c[h], true, f, g);
  ...
  K.uid = 1, K.accepts = n.acceptData, K.prototype = {key: function (a) {
    ...
    var d;
    return undefined === b || b && "string" == typeof b && undefined === c ? (d = this.get(a, b), undefined !== d ? d : this.get(a, n.camelCase(b))) : (this.set(a, b, c), undefined !== c ? c : b);
  }, remove: function (a, b) {
    var c, d, e, f = this.key(a), g = this.cache[f];
    if (undefined === b) this.cache[f] = {}; else {
  ...
  function P(a, b, c) {
    var d;
    if (undefined === c && 1 === a.nodeType) if (d = "data-" + b.replace(O, "-$1").toLowerCase(), c = a.getAttribute(d), "string" == typeof c) {
      try {
  ...
  n.extend({hasData: function (a) {
    ...
    return "object" == typeof a ? this.each(function () {
      ...
      if (f && undefined === b) {
        if (c = M.get(f, a), undefined !== c) return c;
        if (c = M.get(f, d), undefined !== c) return c;
        if (c = P(f, d, undefined), undefined !== c) return c;
      } else this.each(function () {
        var c = M.get(this, d);
        M.set(this, d, b), -1 !== a.indexOf("-") && undefined !== c && M.set(this, a, b);
      });
    ...
    var d;
    return a ? (b = (b || "fx") + "queue", d = L.get(a, b), c && (!d || n.isArray(c) ? d = L.access(a, b, n.makeArray(c)) : d.push(c)), d || []) : undefined;
  ...
  n.event = {global: {}, add: function (a, b, c, d, e) {
    ...
    if (g = h = d = d || l, 3 !== d.nodeType && 8 !== d.nodeType && !X.test(q + n.event.triggered) && (q.indexOf(".") >= 0 && (r = q.split("."), q = r.shift(), r.sort()), k = q.indexOf(":") < 0 && "on" + q, b = b[n.expando] ? b : new n.Event(q, "object" == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = r.join("."), b.namespace_re = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = undefined, b.target || (b.target = d), c = null == c ? [b] : n.makeArray(c, [b]), o = n.event.special[q] || {}, e || !o.trigger || o.trigger.apply(d, c) !== false)) {
      if (!e && !o.noBubble && !n.isWindow(d)) {
        for (i = o.delegateType || q, X.test(i + q) || (g = g.parentNode); g; g = g.parentNode) p.push(g), h = g;
        h === (d.ownerDocument || l) && p.push(h.defaultView || h.parentWindow || a);
      }
      f = 0;
      while ((g = p[f++]) && !b.isPropagationStopped()) b.type = f > 1 ? i : o.bindType || q, m = (L.get(g, "events") || {})[b.type] && L.get(g, "handle"), m && m.apply(g, c), m = k && g[k], m && m.apply && n.acceptData(g) && (b.result = m.apply(g, c), b.result === false && b.preventDefault());
      return b.type = q, e || b.isDefaultPrevented() || o._default && o._default.apply(p.pop(), c) !== false || !n.acceptData(d) || k && n.isFunction(d[q]) && !n.isWindow(d) && (h = d[k], h && (d[k] = null), n.event.triggered = q, d[q](), n.event.triggered = undefined, h && (d[k] = h)), b.result;
    }
  }, dispatch: function (a) {
    a = n.event.fix(a);
    ...
    if (i[0] = a, a.delegateTarget = this, !k.preDispatch || k.preDispatch.call(this, a) !== false) {
      ...
      while ((f = h[b++]) && !a.isPropagationStopped()) {
        ...
        while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped()) (!a.namespace_re || a.namespace_re.test(g.namespace)) && (a.handleObj = g, a.data = g.data, e = ((n.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i), undefined !== e && (a.result = e) === false && (a.preventDefault(), a.stopPropagation()));
      }
      return k.postDispatch && k.postDispatch.call(this, a), a.result;
    }
  }, handlers: function (a, b) {
    var c, d, e, f, g = [], h = b.delegateCount, i = a.target;
    if (h && i.nodeType && (!a.button || "click" !== a.type)) for (; i !== this; i = i.parentNode || this) if (i.disabled !== true || "click" !== a.type) {
      for (d = [], c = 0; h > c; c++) f = b[c], e = f.selector + " ", undefined === d[e] && (d[e] = f.needsContext ? n(e, this).index(i) >= 0 : n.find(e, this, null, [i]).length), d[e] && d.push(f);
    ...
    return null == a.pageX && null != b.clientX && (c = a.target.ownerDocument || l, d = c.documentElement, e = c.body, a.pageX = b.clientX + (d && d.scrollLeft || e && e.scrollLeft || 0) - (d && d.clientLeft || e && e.clientLeft || 0), a.pageY = b.clientY + (d && d.scrollTop || e && e.scrollTop || 0) - (d && d.clientTop || e && e.clientTop || 0)), a.which || undefined === f || (a.which = 1 & f ? 1 : 2 & f ? 3 : 4 & f ? 2 : 0), a;
  }}, fix: function (a) {
    ...
    return "checkbox" === this.type && this.click && n.nodeName(this, "input") ? (this.click(), false) : undefined;
  }, _default: function (a) {
    ...
    return this instanceof n.Event ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || undefined === a.defaultPrevented && a.returnValue === false ? Z : $) : this.type = a, b && n.extend(this, b), this.timeStamp = a && a.timeStamp || n.now(), void (this[n.expando] = true)) : new n.Event(a, b);
    ...
    var f, g;
    if ("object" == typeof a) {
      "string" != typeof b && (c = c || b, b = undefined);
      for (g in a) this.on(g, b, c, a[g], e);
      return this;
    }
    if (null == c && null == d ? (d = b, c = b = undefined) : null == d && ("string" == typeof b ? (d = c, c = undefined) : (d = c, c = b, b = undefined)), d === false) d = $; else if (!d) return this;
    ...
    return (b === false || "function" == typeof b) && (c = b, b = undefined), c === false && (c = $), this.each(function () {
  ...
  n.extend({clone: function (a, b, c) {
    ...
    for (var b, c, d, e, f = n.event.special, g = 0; undefined !== (c = a[g]); g++) {
    ...
    return J(this, function (a) {
      return undefined === a ? n.text(this) : this.empty().each(function () {
    ...
    for (var a, b = 0; null != (a = this[b]); b++) 1 === a.nodeType && (n.cleanData(ob(a, false)), a.textContent = "");
    return this;
  }, clone: function (a, b) {
    ...
    return J(this, function (a) {
      ...
      if (undefined === a && 1 === b.nodeType) return b.innerHTML;
      if ("string" == typeof a && !db.test(a) && !ib[(bb.exec(a) || ["", ""])[1].toLowerCase()]) {
        a = a.replace(ab, "<$1></$2>");
        try {
          for (; d > c; c++) b = this[c] || {}, 1 === b.nodeType && (n.cleanData(ob(b, false)), b.innerHTML = a);
          b = 0;
        } catch (e) {}
      }
    ...
    if (l && (c = n.buildFragment(a, this[0].ownerDocument, false, this), d = c.firstChild, 1 === c.childNodes.length && (c = d), d)) {
      for (f = n.map(ob(c, "script"), kb), g = f.length; l > j; j++) h = c, j !== o && (h = n.clone(h, true, true), g && n.merge(f, ob(h, "script"))), b.call(this[j], h, j);
    ...
    n.fn[a] = function (a) {
      for (var c, d = [], e = n(a), g = e.length - 1, h = 0; g >= h; h++) c = h === g ? this : this.clone(true), n(e[h])[b](c), f.apply(d, c.get());
  ...
  function xb(a, b, c) {
    ...
    return c = c || wb(a), c && (g = c.getPropertyValue(b) || c[b]), c && ("" !== g || n.contains(a.ownerDocument, a) || (g = n.style(a, b)), vb.test(g) && ub.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)), undefined !== g ? g + "" : g;
  }
  function yb(a, b) {
    return {get: function () {
  ...
  function Hb(a, b, c, d, e) {
    for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, g = 0; 4 > f; f += 2) "margin" === c && (g += n.css(a, c + R[f], true, e)), d ? ("content" === c && (g -= n.css(a, "padding" + R[f], true, e)), "margin" !== c && (g -= n.css(a, "border" + R[f] + "Width", true, e))) : (g += n.css(a, "padding" + R[f], true, e), "padding" !== c && (g += n.css(a, "border" + R[f] + "Width", true, e)));
    return g;
  }
  function Ib(a, b, c) {
  ...
  n.extend({cssHooks: {opacity: {get: function (a, b) {
    ...
    if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
      ...
      return b = n.cssProps[h] || (n.cssProps[h] = Fb(i, h)), g = n.cssHooks[b] || n.cssHooks[h], undefined === c ? g && "get" in g && undefined !== (e = g.get(a, false, d)) ? e : i[b] : (f = typeof c, "string" === f && (e = Bb.exec(c)) && (c = (e[1] + 1) * e[2] + parseFloat(n.css(a, b)), f = "number"), null != c && c === c && ("number" !== f || n.cssNumber[h] || (c += "px"), k.clearCloneStyle || "" !== c || 0 !== b.indexOf("background") || (i[b] = "inherit"), g && "set" in g && undefined === (c = g.set(a, c, d)) || (i[b] = c)), undefined);
    }
  }, css: function (a, b, c, d) {
    var e, f, g, h = n.camelCase(b);
    return b = n.cssProps[h] || (n.cssProps[h] = Fb(a.style, h)), g = n.cssHooks[b] || n.cssHooks[h], g && "get" in g && (e = g.get(a, true, c)), undefined === e && (e = xb(a, b, d)), "normal" === e && b in Db && (e = Db[b]), "" === c || c ? (f = parseFloat(e), c === true || n.isNumeric(f) ? f || 0 : e) : e;
    ...
    return b ? n.swap(a, {display: "inline-block"}, xb, [a, "marginRight"]) : undefined;
    ...
    return J(this, function (a, b, c) {
      var d, e, f = {}, g = 0;
      if (n.isArray(b)) {
        for (d = wb(a), e = b.length; e > g; g++) f[b[g]] = n.css(a, b[g], false, d);
        return f;
      }
  ...
  function Vb(a, b, c) {
    var d, e, f, g, h, i, j, k, l = this, m = {}, o = a.style, p = a.nodeType && (a = b || a, "none" === n.css(a, "display") || !n.contains(a.ownerDocument, a)), q = L.get(a, "fxshow");
    ...
    for (d in b) if (e = b[d], Nb.exec(e)) {
      if (delete b[d], f = f || "toggle" === e, e === (p ? "hide" : "show")) {
        if ("show" !== e || !q || undefined === q[d]) continue;
        p = true;
      }
  ...
  n.Animation = n.extend(Xb, {tweener: function (a, b) {
    ...
    c.length || n.fx.stop(), Lb = undefined;
  ...
  n.fn.extend({attr: function (a, b) {
    ...
    if (a && 3 !== f && 8 !== f && 2 !== f) return typeof a.getAttribute === U ? n.prop(a, b, c) : (1 === f && n.isXMLDoc(a) || (b = b.toLowerCase(), d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? Zb : Yb)), undefined === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : (e = n.find.attr(a, b), null == e ? undefined : e) : null !== c ? d && "set" in d && undefined !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void n.removeAttr(a, b));
  ...
  n.fn.extend({prop: function (a, b) {
    ...
    if (a && 3 !== g && 8 !== g && 2 !== g) return f = 1 !== g || !n.isXMLDoc(a), f && (b = n.propFix[b] || b, e = n.propHooks[b]), undefined !== c ? e && "set" in e && undefined !== (d = e.set(a, c, b)) ? d : a[b] = c : e && "get" in e && null !== (d = e.get(a, b)) ? d : a[b];
  ...
  n.fn.extend({addClass: function (a) {
    ...
    return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : this.each(n.isFunction(a) ? function (c) {
      ...
      } else (c === U || "boolean" === c) && (this.className && L.set(this, "__className__", this.className), this.className = this.className || a === false ? "" : L.get(this, "__className__") || "");
    });
  }, hasClass: function (a) {
    for (var b = " " + a + " ", c = 0, d = this.length; d > c; c++) if (1 === this[c].nodeType && (" " + this[c].className + " ").replace(ac, " ").indexOf(b) >= 0) return true;
    return false;
  }});
  var bc = /\r/g;
  n.fn.extend({val: function (a) {
    var b, c, d, e = this[0];
    {
      ...
      if (e) return b = n.valHooks[e.type] || n.valHooks[e.nodeName.toLowerCase()], b && "get" in b && undefined !== (c = b.get(e, "value")) ? c : (c = e.value, "string" == typeof c ? c.replace(bc, "") : null == c ? "" : c);
    }
    ...
    while (g--) d = e[g], (d.selected = n.inArray(d.value, f) >= 0) && (c = true);
    return c || (a.selectedIndex = -1), f;
  }}}}), n.each(["radio", "checkbox"], function () {
    n.valHooks[this] = {set: function (a, b) {
      return n.isArray(b) ? a.checked = n.inArray(n(a).val(), b) >= 0 : undefined;
  ...
  function sc(a, b) {
    ...
    for (c in b) undefined !== b[c] && ((e[c] ? a : d || (d = {}))[c] = b[c]);
    return d && n.extend(true, a, d), a;
  }
  function tc(a, b, c) {
    var d, e, f, g, h = a.contents, i = a.dataTypes;
    while ("*" === i[0]) i.shift(), undefined === d && (d = a.mimeType || b.getResponseHeader("Content-Type"));
  ...
  n.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: oc, type: "GET", isLocal: hc.test(pc[1]), global: true, processData: true, async: true, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": nc, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText", json: "responseJSON"}, converters: {"* text": String, "text html": true, "text json": n.parseJSON, "text xml": n.parseXML}, flatOptions: {url: true, context: true}}, ajaxSetup: function (a, b) {
    ...
    "object" == typeof a && (b = a, a = undefined), b = b || {};
    ...
    i = n.event && k.global, i && 0 === n.active++ && n.event.trigger("ajaxStart"), k.type = k.type.toUpperCase(), k.hasContent = !ic.test(k.type), d = k.url, k.hasContent || (k.data && (d = k.url += (dc.test(d) ? "&" : "?") + k.data, delete k.data), k.cache === false && (k.url = fc.test(d) ? d.replace(fc, "$1_=" + cc++) : d + (dc.test(d) ? "&" : "?") + "_=" + cc++)), k.ifModified && (n.lastModified[d] && v.setRequestHeader("If-Modified-Since", n.lastModified[d]), n.etag[d] && v.setRequestHeader("If-None-Match", n.etag[d])), (k.data && k.hasContent && k.contentType !== false || b.contentType) && v.setRequestHeader("Content-Type", k.contentType), v.setRequestHeader("Accept", k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + nc + "; q=0.01" : "") : k.accepts["*"]);
    ...
    function x(a, b, f, h) {
      var j, r, s, u, w, x = b;
      2 !== t && (t = 2, g && clearTimeout(g), c = undefined, e = h || "", v.readyState = a > 0 ? 4 : 0, j = a >= 200 && 300 > a || 304 === a, f && (u = tc(k, v, f)), u = uc(k, u, v, j), j ? (k.ifModified && (w = v.getResponseHeader("Last-Modified"), w && (n.lastModified[d] = w), w = v.getResponseHeader("etag"), w && (n.etag[d] = w)), 204 === a || "HEAD" === k.type ? x = "nocontent" : 304 === a ? x = "notmodified" : (x = u.state, r = u.data, s = u.error, j = !s)) : (s = x, (a || !x) && (x = "error", 0 > a && (a = 0))), v.status = a, v.statusText = (b || x) + "", j ? o.resolveWith(l, [r, x, v]) : o.rejectWith(l, [v, x, s]), v.statusCode(q), q = undefined, i && m.trigger(j ? "ajaxSuccess" : "ajaxError", [v, k, j ? r : s]), p.fireWith(l, [v, x]), i && (m.trigger("ajaxComplete", [v, k]), --n.active || n.event.trigger("ajaxStop")));
    }
    return v;
    ...
    n[b] = function (a, c, d, e) {
      return n.isFunction(c) && (e = e || d, d = c, c = undefined), n.ajax({url: a, type: b, dataType: e, data: c, success: d});
    };
  ...
  a.attachEvent && a.attachEvent("onunload", function () {
    ...
    return k.cors || Ec && !a.crossDomain ? {send: function (c, d) {
      ...
      b = function (a) {
        return function () {
          b && (delete Cc[g], b = f.onload = f.onerror = null, "abort" === a ? f.abort() : "error" === a ? d(f.status, f.statusText) : d(Dc[f.status] || f.status, f.statusText, "string" == typeof f.responseText ? {text: f.responseText} : undefined, f.getAllResponseHeaders()));
        };
    ...
    undefined === a.cache && (a.cache = false), a.crossDomain && (a.type = "GET");
  ...
  n.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
    ...
    var e, f, g, h = b.jsonp !== false && (Gc.test(b.url) ? "url" : "string" == typeof b.data && !(b.contentType || "").indexOf("application/x-www-form-urlencoded") && Gc.test(b.data) && "data");
    return h || "jsonp" === b.dataTypes[0] ? (e = b.jsonpCallback = n.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, h ? b[h] = b[h].replace(Gc, "$1" + e) : b.jsonp !== false && (b.url += (dc.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), b.converters["script json"] = function () {
      return g || n.error(e + " was not called"), g[0];
    }, b.dataTypes[0] = "json", f = a[e], a[e] = function () {
      g = arguments;
    }, d.always(function () {
      a[e] = f, b[e] && (b.jsonpCallback = c.jsonpCallback, Fc.push(e)), g && n.isFunction(f) && f(g[0]), g = f = undefined;
    }), "script") : undefined;
  ...
  n.fn.load = function (a, b, c) {
    ...
    return h >= 0 && (d = n.trim(a.slice(h)), a = a.slice(0, h)), n.isFunction(b) ? (c = b, b = undefined) : b && "object" == typeof b && (e = "POST"), g.length > 0 && n.ajax({url: a, type: e, dataType: "html", data: b}).done(function (a) {
  ...
  n.offset = {setOffset: function (a, b, c) {
    ...
    n.fn[b] = function (e) {
      return J(this, function (b, e, f) {
        var g = Jc(b);
        return undefined === f ? g ? g[c] : b[e] : void (g ? g.scrollTo(d ? a.pageXOffset : f, d ? f : a.pageYOffset) : b[e] = f);
      }, b, e, arguments.length, null);
    };
  }), n.each(["top", "left"], function (a, b) {
    n.cssHooks[b] = yb(k.pixelPosition, function (a, c) {
      return c ? (c = xb(a, b), vb.test(c) ? n(a).position()[b] + "px" : c) : undefined;
    });
