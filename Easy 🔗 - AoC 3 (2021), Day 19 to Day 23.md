...
Click <a href="https://tryhackme.com/room/adventofcyber3"> here</a> to dive into this challenge.</p>
...
![image](https://github.com/user-attachments/assets/68c5b688-5b14-4c65-8f7b-d95746919f9d)


![image](https://github.com/user-attachments/assets/d60871bf-249a-4fc3-b16a-088b20e1db8c)
...
<p>5. Go to this link to learn more about this file and what it is used for. What were the first two names of this file?<br>
<code>ducklin.htm or ducklin-html.htm</code></p>


![image](https://github.com/user-attachments/assets/e5a72083-a33c-4cc2-8616-2d8e124bae0a)

<p>6 . The file has 68 characters in the start known as the known string. It can be appended with whitespace characters upto a limited number of characters. What is the maximum number of total characters that can be in the file?<br>
<code>128</code></p>


![image](https://github.com/user-attachments/assets/6967a0a5-1a70-4b19-93c7-bf7b67dbc71d)
...
![image](https://github.com/user-attachments/assets/838000e8-aa0c-4223-9fd0-8704f9d31221)
...
| :---------------: | :------: | :----------: | :----------: | :---------: | :--------: | :------  | :-------: | :-------: |
|                   |          |    Global    |    Brazil    |    Global   |   Brazil   |          | Completed |           |
| June 16 2025      | 406      |     203ʳᵈ    |      5ᵗʰ     |     382nd   |     8ᵗʰ    | 107,987  |    780    |     62    |

</div>

![image](https://github.com/user-attachments/assets/19678c4f-a7d6-4351-935e-bcb65fbbd601)


![image](https://github.com/user-attachments/assets/4b33bc37-93d8-409a-b32a-b6a609de1efd)


![image](https://github.com/user-attachments/assets/0ff567b3-a149-4051-bc53-9765e2027a82)

![image](https://github.com/user-attachments/assets/8f0c78ae-99b6-4dd5-a452-779319c8f123)


![image](https://github.com/user-attachments/assets/30b630f6-a10c-44c5-8506-bb6a80d0f5ec)
...
<p>1 . We changed the text in the string $a as shown in the eicaryara rule we wrote, from X5O to X50, that is, we replaced the letter O with the number 0. The condition for the Yara rule is $a and $b and $c and $d. If we are to only make a change to the first boolean operator in this condition, what boolean operator shall we replace the 'and' with, in order for the rule to still hit the file?<br>
<code>or</code></p>

<br>

<p>2 . What option is used in the Yara command in order to list down the metadata of the rules that are a hit to a file? <br>
<code>-m</code></p>

![image](https://github.com/user-attachments/assets/a0a4c27c-222f-4799-a74a-26ef0a964d6d)


<br>

<p>3 . What section contains information about the author of the Yara rule? <br>
<code>metadata</code></p>

![image](https://github.com/user-attachments/assets/0ba6502b-80a1-4902-beca-f4dcae4a6bff)


<br>

<p>4 . What option is used to print only rules that did not hit?<br>
<code>-n</code></p>

<br>

<p>5 . Change the Yara rule value for the $a string to X50. Rerun the command, but this time with the -c option. What is the result?<br>
<code>0</code></p>

<br>

![image](https://github.com/user-attachments/assets/58ced5ba-4600-4625-9681-142b63911cd7)
...
| :---------------: | :------: | :----------: | :----------: | :---------: | :--------: | :------  | :-------: | :-------: |
|                   |          |    Global    |    Brazil    |    Global   |   Brazil   |          | Completed |           |
| June 16 2025      | 406      |     203ʳᵈ    |      5ᵗʰ     |     382nd   |     8ᵗʰ    |  108,027 |    780    |     62    |

</div>

![image](https://github.com/user-attachments/assets/77696840-2409-4883-9567-817600fc3b8d)


![image](https://github.com/user-attachments/assets/b8344a41-e606-470f-ae4d-bdf68075ef42)


![image](https://github.com/user-attachments/assets/975c4602-2841-4b8b-a44d-434ffb9f27fb)

![image](https://github.com/user-attachments/assets/288a77a4-30cf-48df-8dc9-da055a45a296)


![image](https://github.com/user-attachments/assets/eb970609-67c9-4381-9912-ea9e6cc48e2e)
...
<p>1 . What is the username (email address of Grinch Enterprises) from the decoded script?<br>
<code>Grinch.Enterprises.2021@gmail.com</code></p>

![image](https://github.com/user-attachments/assets/b73f9750-35e3-4c80-bd23-3be2adb4b44d)

<p>C:\Users\Administrator\Desktop\Santa_Claus_Naughty_List_2021\Santa_Claus_Naughty_List_2021.doc</p>

![image](https://github.com/user-attachments/assets/55ed9019-ee07-4f61-85a9-7c66785c6206)

![image](https://github.com/user-attachments/assets/2e0f02b5-0a8c-4f61-b684-d7443ec77abf)


<p>GrinchEnterprisesIsComingForYou
...
![image](https://github.com/user-attachments/assets/57582677-b0fc-4921-b63b-37ef0b9752bc)


<br>

<p>2 . What is the mailbox password you found? <br>
<code>S@ntai$comingt0t0wn</code></p>

![image](https://github.com/user-attachments/assets/4b531b86-c372-46f3-8d1c-421da8434e01)

<br>

<p>3 . What is the mailbox password you found? <br>
<code>Christmas Wishlist</code>
  
![image](https://github.com/user-attachments/assets/10c5433a-4b32-42e6-ba01-f194d088eb68)

<br>

<p>4 . What port is the script using to exfiltrate data from the North Pole? <br>
<code>587</code>

![image](https://github.com/user-attachments/assets/2be9f8b3-fe90-4260-9c2c-fa17ddc106be)

<br>

<p>5 . What is the flag hidden found in the document that Grinch Enterprises left behind? (Hint: use the following command oledump.py -s {stream number} -d, the answer will be in the caption). <br>
<code>YouFoundGrinchCookie</code>

![image](https://github.com/user-attachments/assets/891b333d-765d-4f55-ace6-aaa548509894)

<br>

<p>6 . There is still a second flag somewhere... can you find it on the machine? <br>
<code>S@nt@c1Au$IsrEAl</code>

![image](https://github.com/user-attachments/assets/55a9e095-80cf-4421-b588-327ea5bdb196)

![image](https://github.com/user-attachments/assets/b6d22a53-80e0-48c1-b622-0cf377b062f0)

<br>
<br>

![image](https://github.com/user-attachments/assets/1902cd4f-7cbd-4960-a84c-90aaa00b1bec)
...
| :---------------: | :------: | :----------: | :----------: | :---------: | :--------: | :------  | :-------: | :-------: |
|                   |          |    Global    |    Brazil    |    Global   |   Brazil   |          | Completed |           |
| June 16 2025      | 406      |     203ʳᵈ    |      5ᵗʰ     |     383rd   |     8ᵗʰ    |  108,075 |    780    |     62    |

</div>

![image](https://github.com/user-attachments/assets/b9f3943e-fba8-421c-b1ff-d4117ff2187e)


![image](https://github.com/user-attachments/assets/cf2bf627-c928-44e1-8635-c559bbceb072)

![image](https://github.com/user-attachments/assets/196f5ef4-ca08-481d-8860-bcd3166f1fee)


![image](https://github.com/user-attachments/assets/c7656055-37eb-4f01-b5a3-a87867e83108)
